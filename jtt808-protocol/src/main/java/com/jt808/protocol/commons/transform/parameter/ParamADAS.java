...
public class ParamADAS {
    ...
    private byte p00 = -1;
    @Field(desc = "Alarm prompt volume BYTE")
    private byte p01 = -1;
    ...
    private int p15 = -1;
    @Field(desc = "reserved field BYTE")
    private byte p19 = -1;
    @Field(desc = "Obstacle alarm distance threshold BYTE")
    private byte p20 = -1;
    @Field(desc = "Obstacle alarm classification speed threshold BYTE")
    private byte p21 = -1;
    @Field(desc = "Video recording time before and after obstacle alarm BYTE")
    private byte p22 = -1;
    @Field(desc = "Number of photos taken for obstacle alarm BYTE")
    private byte p23 = -1;
    @Field(desc = "Obstacle alarm photo interval BYTE")
    private byte p24 = -1;
    @Field(desc = "Frequent lane change alarm judgment time period BYTE")
    private byte p25 = -1;
    @Field(desc = "Frequent lane change alarm judgment times BYTE")
    private byte p26 = -1;
    @Field(desc = "Frequent lane change alarm classification speed threshold BYTE")
    private byte p27 = -1;
    @Field(desc = "Video recording time before and after frequent lane change alarm BYTE")
    private byte p28 = -1;
    @Field(desc = "Number of photos taken for frequent lane change alarms BYTE")
    private byte p29 = -1;
    @Field(desc = "Frequent lane change alarm camera interval BYTE")
    private byte p30 = -1;
    @Field(desc = "Lane Departure Alert Classification Speed Threshold BYTE")
    private byte p31 = -1;
    @Field(desc = "Video recording time before and after lane departure warning BYTE")
    private byte p32 = -1;
    @Field(desc = "Number of photos taken for lane departure warning BYTE")
    private byte p33 = -1;
    @Field(desc = "Lane departure warning photo interval BYTE")
    private byte p34 = -1;
    @Field(desc = "Forward Collision Warning Time Threshold BYTE")
    private byte p35 = -1;
    @Field(desc = "Forward Collision Alert Classification Speed Threshold BYTE")
    private byte p36 = -1;
    @Field(desc = "Video recording time before and after forward collision warning BYTE")
    private byte p37 = -1;
    @Field(desc = "Number of photos taken for forward collision warning BYTE")
    private byte p38 = -1;
    @Field(desc = "Forward Collision Alarm Photo Interval BYTE")
    private byte p39 = -1;
    @Field(desc = "Pedestrian collision warning time threshold BYTE")
    private byte p40 = -1;
    @Field(desc = "Pedestrian collision warning enable speed threshold BYTE")
    private byte p41 = -1;
    @Field(desc = "Video recording time before and after pedestrian collision alarm BYTE")
    private byte p42 = -1;
    @Field(desc = "Number of photos taken for pedestrian collision alarm BYTE")
    private byte p43 = -1;
    @Field(desc = "Pedestrian collision alarm photo interval BYTE")
    private byte p44 = -1;
    @Field(desc = "Vehicle distance monitoring alarm distance threshold BYTE")
    private byte p45 = -1;
    @Field(desc = "Vehicle distance monitoring alarm classification speed threshold BYTE")
    private byte p46 = -1;
    @Field(desc = "Video recording time before and after the vehicle distance alarm BYTE")
    private byte p47 = -1;
    @Field(desc = "The number of photos taken for the alarm when the vehicle is too close BYTE")
    private byte p48 = -1;
    @Field(desc = "Vehicle distance is too close alarm photo interval BYTE")
    private byte p49 = -1;
    @Field(desc = "Number of photos taken for road sign recognition BYTE")
    private byte p50 = -1;
    @Field(desc = "Road Sign Recognition Photo Interval BYTE")
    private byte p51 = -1;
    @Field(desc = "Solid line lane change alarm classification speed threshold BYTE(Cantonese standard)")
    private byte p52 = -1;
    @Field(desc = "Video recording time before and after the solid line lane change alarm BYTE(Cantonese standard)")
    private byte p53 = -1;
    @Field(desc = "Number of photos taken for solid line change alarm BYTE(Cantonese standard)")
    private byte p54 = -1;
    @Field(desc = "Solid line lane change alarm photo interval BYTE(Cantonese standard)")
    private byte p55 = -1;
    @Field(desc = "Pedestrian detection alarm classification speed threshold in carriage aisle BYTE(Cantonese standard)")
    private byte p56 = -1;
