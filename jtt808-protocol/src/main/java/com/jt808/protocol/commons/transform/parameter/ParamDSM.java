...
public class ParamDSM {
    ...
    @Field(desc = "Alarm judgment speed threshold BYTE")
    private byte p00 = -1;
    @Field(desc = "Alarm volume BYTE")
    private byte p01 = -1;
    @Field(desc = "Active photo strategy BYTE")
    private byte p02 = -1;
    @Field(desc = "Active timed photo time interval WORD")
    private short p03 = -1;
    @Field(desc = "Active fixed distance camera distance interval WORD")
    private short p05 = -1;
    @Field(desc = "Number of photos taken at one time BYTE")
    private byte p07 = -1;
    @Field(desc = "Time interval for a single active photo BYTE")
    private byte p08 = -1;
    @Field(desc = "Photo resolution BYTE")
    private byte p09 = -1;
    @Field(desc = "Video recording resolution BYTE")
    private byte p10 = -1;
    @Field(desc = "Alarm enable DWORD")
    private int p11 = -1;
    @Field(desc = "event enable DWORD")
    private int p15 = -1;
    @Field(desc = "Smoking alarm judgment time interval WORD")
    private short p19 = -1;
    @Field(desc = "Time interval for receiving and calling alarm judgment WORD")
    private short p21 = -1;
    @Field(desc = "reserved field BYTE[3]")
    private byte[] p23 = new byte[3];
    @Field(desc = "Fatigue driving warning classification speed threshold BYTE")
    private byte p26 = -1;
    @Field(desc = "Video recording time before and after fatigue driving alarm BYTE")
    private byte p27 = -1;
    @Field(desc = "Number of photos taken for fatigue driving alarm BYTE")
    private byte p28 = -1;
    @Field(desc = "Fatigue driving alarm photographing interval BYTE")
    private byte p29 = -1;
    @Field(desc = "Alarm classification speed threshold for incoming and outgoing calls BYTE")
    private byte p30 = -1;
    @Field(desc = "Video recording time before and after the call and alarm BYTE")
    private byte p31 = -1;
    @Field(desc = "The number of photos of the driver's facial features taken when answering the phone and calling the police BYTE")
    private byte p32 = -1;
    @Field(desc = "Interval time between answering and calling the police and taking photos of the driver's facial features BYTE")
    private byte p33 = -1;
    @Field(desc = "Smoking alarm classification speed threshold BYTE")
    private byte p34 = -1;
    @Field(desc = "Video recording time before and after smoking alarm BYTE")
    private byte p35 = -1;
    @Field(desc = "The number of photos of the driver's facial features taken by the smoking alarm BYTE")
    private byte p36 = -1;
    @Field(desc = "Interval time between smoking alarm and taking photos of driver's facial features BYTE")
    private byte p37 = -1;
    @Field(desc = "Distracted Driving Warning Graded Speed Threshold BYTE")
    private byte p38 = -1;
    @Field(desc = "Video recording time before and after distracted driving alarm BYTE")
    private byte p39 = -1;
    @Field(desc = "Number of photos taken for distracted driving alarm BYTE")
    private byte p40 = -1;
    @Field(desc = "Distracted driving alarm photo interval time BYTE")
    private byte p41 = -1;
    @Field(desc = "Speed threshold for abnormal driving behavior classification BYTE")
    private byte p42 = -1;
    @Field(desc = "Abnormal driving behavior video recording time BYTE")
    private byte p43 = -1;
    @Field(desc = "Number of snapshots of abnormal driving behavior BYTE")
    private byte p44 = -1;
    @Field(desc = "Abnormal driving behavior photographing interval BYTE")
    private byte p45 = -1;
    @Field(desc = "Driver ID Triggered BYTE")
    private byte p46 = -1;
    @Field(desc = "Camera occlusion alarm classification speed threshold (Guangdong standard)")
    private byte p47 = -1;
    @Field(desc = "Not wearing seat belt alarm classification speed threshold (Guangdong standard)")
    private byte p48 = -1;
    @Field(desc = "Video recording time before and after the alarm without a seat belt (Cantonese standard)")
    private byte p49 = -1;
    @Field(desc = "Number of photos taken without seat belt alarm (Cantonese standard)")
    private byte p50 = -1;
    @Field(desc = "No seat belt alarm snapshot photo interval (Cantonese standard)")
    private byte p51 = -1;
    @Field(desc = "Infrared sunglasses blocking failure alarm classification speed threshold (Guangdong standard)")
    private byte p52 = -1;
    @Field(desc = "Video recording time before and after infrared sunglasses blocking failure alarm (Guangdong standard)")
    private byte p53 = -1;
    @Field(desc = "Number of photos taken by infrared sunglasses blocking failure alarm (Guangdong standard)")
    private byte p54 = -1;
    @Field(desc = "Infrared sunglasses blocking failure alarm snapshot photo interval (Guangdong standard)")
    private byte p55 = -1;
    @Field(desc = "Double-drop handle alarm classification speed threshold (Guangdong standard)")
    private byte p56 = -1;
    @Field(desc = "Video recording time before and after the double-off handle alarm (Cantonese standard)")
    private byte p57 = -1;
    @Field(desc = "Number of photos taken by the double pull-off alarm (Cantonese standard)")
    private byte p58 = -1;
    @Field(desc = "Interval time between double-off alarm and snapshot photos (Cantonese standard)")
    private byte p59 = -1;
    @Field(desc = "Play mobile phone alarm classification speed threshold (Cantonese standard)")
    private byte p60 = -1;
    @Field(desc = "Video recording time before and after playing mobile phone alarm (Cantonese standard)")
    private byte p61 = -1;
    @Field(desc = "Number of photos taken by playing mobile phone alarm (Cantonese standard)")
    private byte p62 = -1;
    @Field(desc = "Play mobile phone alarm shooting, photo interval time (Cantonese standard)")
    private byte p63 = -1;
    @Field(desc = "Reserved field (Cantonese standard)")
    private byte p64 = -1;
