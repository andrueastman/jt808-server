...
import com.jt808.protocol.commons.MessageId;
...
public class JTMessage implements Message {
    ...
    @Field(length = 2, desc = "Message Id")
    protected int messageId;
    @Field(length = 2, desc = "Properties")
    protected int properties;
    @Field(length = 1, desc = "Protocol version", version = 1)
    protected int protocolVersion;
    @Field(length = 6, charset = "BCD", desc = "Client Id", version = {-1, 0})
    @Field(length = 10, charset = "BCD", desc = "Client Id", version = 1)
    protected String clientId;
    @Field(length = 2, desc = "Serial Number")
    protected int serialNo;
    @Field(length = 2, desc = "Package Total")
    protected Integer packageTotal;
    @Field(length = 2, desc = "Package Number")
